...
plot_ly(z = t(m), colorscale = "Viridis") %>%
...
plot_ly(z = t(g), colorscale = "Viridis") %>%
...
plot_ly(z = t(u), colorscale = "Viridis") %>%
...
plot_ly(z = w,colorscale = "Viridis") %>%
...
```{r}
added_layers <-c(pop_layers, gdp_layers,ul_layers,ahe_layers,uhi_layers,pu_layers)
```
